...
export const Icon = ({
  ...
  return (
    <>
      <span
        className={clsx(
          "w-[5.5rem] h-[5.5rem] sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 rounded flex items-center justify-center cursor-pointer hover:scale-110 relative perspective-10"
        )}
        {...props}
      >
        <div
